...
/// η = 1/T² − 1 ≈ 24 at T = 0.2 (ScaNN default). Parallel quantization
/// error is weighted 24× higher than perpendicular — it's the component
/// that affects dot-product ranking. See docs/plans/metric_per_tier_plan.md Phase 2.
///
...
public:
    ...
    /// threshold T (default 0.2 from ScaNN §5). η = 1/T²−1 ≈ 24.
    /// T = 0 ⟹ η = 1 (recovers standard L2 k-means).
